...
@export var min_camera_speed = 100.0
@export var max_camera_speed = 300.0
@export var camera_y_threshold = 0.7  # 螢幕 70% 以下時開始加速
...
func _ready():
	...
	river_game_1.camera_to(Vector2(1920, 2160), 0.5, 1)
